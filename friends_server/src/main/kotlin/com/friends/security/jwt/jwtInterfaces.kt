...
abstract class JwtCreater {
    companion object {
        fun createAccessToken(memberId: Long, authorities: Collection<GrantedAuthority>) : String {
            TODO("Not yet implemented")
        }

        fun createRefreshToken(memberId: Long, authorities: Collection<GrantedAuthority>) : String{
            TODO("Not yet implemented")
        }
    }
