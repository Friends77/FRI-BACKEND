...
fun createTestProfileResponseDto(): ProfileResponseDto = ProfileResponseDto(nickname = createTestMember().nickname, email = "test@test.com", birth = LocalDate.now(), gender = GenderEnum.MAN, selfDescription = "test self description", imageUrl = "test imageurl", mbti = MbtiEnum.ENFJ)

fun createTestProfileCreateDto(): ProfileCreateDto = ProfileCreateDto(birth = LocalDate.now(), gender = GenderEnum.MAN, location = LocationDto(10.0, 10.0), selfDescription = "test self description", imageUrl = "test imageurl")

fun updateTestProfile(): ProfileUpdateDto = ProfileUpdateDto(birth = LocalDate.now(), gender = GenderEnum.WOMAN, location = LocationDto(10.0, 10.0), selfDescription = "test update self description", mbti = MbtiEnum.ENTJ, imageUrl = "test update imageurl")

fun createPoint(
    lng: Double,
    lat: Double,
): Point = GeometryFactory().createPoint(Coordinate(lng, lat))
